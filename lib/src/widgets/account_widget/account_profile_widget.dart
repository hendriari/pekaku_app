...
import 'package:pekaku_app/src/widgets/account_widget/logout_dialog.dart';
import 'package:pekaku_app/src/widgets/account_widget/row_widget.dart';
import 'package:pekaku_app/src/widgets/account_widget/text_field_account.dart';
...
class AccountProfileWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        padding: EdgeInsets.only(left: 10, right: 10, top: paddingTop + 2),
        child: Column(
